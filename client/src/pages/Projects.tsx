        ...
        <>
            ...
            <section className="section page-hero">
                <div className="container page-hero-shell">
                    ...
                    <div className="page-hero-badge mono">PRODUCT / SYSTEM / EXPERIENCE</div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="focus-grid">
                        <article className="focus-card">
                            <span className="signal-label mono">Content Systems</span>
                            <h3>内容产品与发布链路</h3>
                            <p>内容结构化、写作系统、发布流程，以及可长期积累的站点资产。</p>
                        </article>
                        <article className="focus-card">
                            <span className="signal-label mono">Interface Craft</span>
                            <h3>界面体验与设计语言</h3>
                            <p>前端体验、品牌感表达、组件秩序和信息层级控制。</p>
                        </article>
                        <article className="focus-card">
                            <span className="signal-label mono">AI Workflow</span>
                            <h3>AI 驱动的生产效率</h3>
